<template>
	<mdb-card>
		...
		<mdb-card-body class="text-center">
			<mdb-card-title>Diaeddin BOUIDAINE</mdb-card-title>
			<mdb-card-text>Directeur de departement d'Ingénieurie</mdb-card-text>
			<mdb-btn color="elegant" disabled>View Profile</mdb-btn>
		</mdb-card-body>
	</mdb-card>
</template>
<script>
